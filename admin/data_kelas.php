              ...
              <?php    
                ...
                <tr>
                  ...
                  <td class ="text-center"> 
                    ...
                    <a href="<?= $base_url ?>proses_admin/data_kelas/delete.php?id=<?= $row['id_kelas'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                    <a href="<?= $base_url ?>admin/data_detail_kelas.php?id=<?= $row['id_kelas'] ?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
