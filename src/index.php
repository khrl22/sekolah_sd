...
<div id="home" class="slider-area">
  <div class="bend niceties preview-2">
    <div id="ensign-nivoslider" class="slides">
      <img src="<?= $base_url?>assets_wali/img/slider/gambar11.jpg" alt="" title="#slider-direction-1" />
      <img src="<?= $base_url?>assets_wali/img/slider/gambar22.jpg" alt="" title="#slider-direction-2" />
      <img src="<?= $base_url?>assets_wali/img/slider/gambar33.jpg" alt="" title="#slider-direction-3" />
    </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-1 hidden-xs wow animate__slideInDown animate__animated" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">SDN 025 Cikutra</h2>
                ...
                <div class="layer-1-2 wow animate__fadeIn animate__animated" data-wow-duration="2s" data-wow-delay=".2s">
                  <h1 class="title2">Selamat Datang di SDN 025 Cikutra</h1>
                </div>
                <!-- layer 3 -->
      ...
      <div class="contact-inner area-padding">
        ...
        <div class="container ">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <!-- Start Map
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.9765183637915!2d107.6346309741062!3d-6.893411967455391!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e7a3481c652f%3A0x937192dd070c65a4!2sSDN%20025%20Cikutra!5e0!3m2!1sid!2sid!4v1744609463942!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" height="380" frameborder="0" style="border:0" allowfullscreen></iframe> -->
            ...
            <div class="well-middle">
              <div class="single-well">
                <h4>Information</h4>
                <p>
                Aplikasi SDN 025 Cikutra
                </p>
                <div class="single-well">
                  <p><span>Alamat</span> Jl. Cikutra No.326, Neglasari, Kec. Cibeunying Kaler, Kota Bandung, Jawa Barat 40124</p>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-body">
        <div class="form-group">
            <label for="">Apakah sistem monitoring sangat berguna untuk memantau perkembangan belajar </label>
            ...
            <br>
            <label for="">Apakah sistem ini membantu memberikan informasi mengenai SDN 025 Cikutra?</label>
            <div class="form-check">
              <label class="form-check-label">
            ...
            <br>
            <label for="">Bagaimana penerapan sistem ini pada SD apakah sangat membantu?</label>
            <div class="form-check">
              <label class="form-check-label">
